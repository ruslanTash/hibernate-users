...
public class Application {
    public static void main(String[] args) {
        ...
        userDAO.createUser(new User(1, "Ivan", "NeDurak", "1234", new ArrayList<Functional>(Arrays.asList(f1, f3))));
        userDAO.createUser(new User(2, "Alena", "PriMudraya", "3939", new ArrayList<Functional>(Arrays.asList(f2, f4))));
        userDAO.createUser(new User(3, "Koshey", "Immortal", "666666", new ArrayList<Functional>(Arrays.asList(f1, f3))));
...
//        Редактировать существующего пользователя в БД.
        userDAO.updateUser(new User(3, "Zmey", "Gorinich", "7777", new ArrayList<Functional>(Arrays.asList(f1, f3))), 3);
